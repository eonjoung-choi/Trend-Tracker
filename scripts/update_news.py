...
- 우리는 '앱/디지털 프로덕트' 트렌드 트래커입니다. 특정 브랜드 기사는 앱·웹·결제·인증·비대면·UX·멤버십·포인트·자동화 등 '디지털/앱 접점'이 있어야 "yes".
- 단순 금융상품(중금리대출·예금·적금·금리·보험 상품 등) 출시로 앱/디지털 변화·비대면 접점이 전혀 없으면 "no".
  (단 '앱에서 비대면 신청', '앱 전용 상품', '앱 내 한도조회·간편신청' 등 디지털 접점이 있으면 "yes")
